...
The exercises are written in Python and primarily use the [hydroserverpy](https://hydroserver.org/user-guides/tutorials/getting-started-with-hydroserverpy/) package. 

You can learn more about hydroserverpy in the [official documentation](https://pypi.org/project/hydroserverpy/). 

You can also read more about the HydroServer Sensorthings API [here](https://lro.hydroserver.org/api/sensorthings/v1.1/docs).
